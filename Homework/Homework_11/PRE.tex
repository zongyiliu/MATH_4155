...
\usepackage[]{amsthm} %lets us use \begin{proof}
	...
	\begin{document}
		...
		{\color{deepred}\fontspec{Georgia} HW11 Q7 Birth-and-Death Markov Chain} 
		
		 Consider a random walk on the non-negative integers $\mathcal{S} = \mathbb{N}_0$, with the entries of its transition probability matrix $\mathcal{P}$ given by
		\[
