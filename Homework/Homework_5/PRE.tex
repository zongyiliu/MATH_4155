...
\usepackage[]{amsthm} %lets us use \begin{proof}
	...
	\begin{document}
		...
		{\color{deepred}\fontspec{Georgia} Rejection Sampling}
		
		Let $X$ and $Y$ be random variables with possible values in the countable set $\mathfrak{Z}=\left\{z_{1}, z_{2}, \cdots\right\}$ and such that
